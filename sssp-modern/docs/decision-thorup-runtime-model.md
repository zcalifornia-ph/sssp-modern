...
3.  **Simplifications**: Instead of the full component hierarchy mapping originally described by Thorup to avoid any sorting, our reference implementation may use an explicit bitwise-trie or tiered bucket array. This is a structural analogue for Thorup's bucket-routing idea, not a claim that Python bitwise routing preserves the original word-RAM constant-time operation model.
