...
\begin{frame}{Author Contributions}
  ...
  \vskip 2pt
  \begin{center}
    \footnotesize Contribution split follows the provided commit history\\and the completed Rizal-assigned contributions.
  \end{center}
\end{frame}
...
\begin{frame}{Backup: Result Evidence}
  \footnotesize
  \begin{block}{Files to cite during Q\&A}
    \begin{itemize}
