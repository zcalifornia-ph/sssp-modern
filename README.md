...
<h3 align="center">sssp-modern</h3>
  ...
  <p align="center">
    ...
    Version: v0.1.0
    <br />
    Status: Foundation implementation (graph and weight primitives with tests)
    <br />
...
Status: foundation implementation (`v0.1.0`). The repository now includes the first pure-stdlib Python primitives used by the planned shortest-path implementations: weighted graph structures and a comparison-addition `Weight` wrapper.
...
3. Run the current foundation tests.
   ...
   ```sh
   cd sssp-modern
   PYTHONPATH=src python -m pytest tests/test_graph.py tests/test_weights.py
   ```
...
- [ ] v0.1.1 - Graph IO helpers and sample fixtures.
