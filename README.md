...
<h3 align="center">sssp-modern</h3>
  ...
  <p align="center">
    ...
    Version: v0.5.8
    <br />
    Status: Dijkstra, Bellman-Ford, A*, Thorup, and the modern directed-sparse SSSP driver are in place; benchmark timing, dataset catalog, result CSV writing, runtime chart rendering, and the completed written report are available; the presentation now carries the result-evidence slide in the main talk flow with a repository citation, and the report's AI assistance disclosure distinguishes Claude planning support from OpenAI Codex GPT 5.5 implementation support, with dry-run pacing and submission packaging still pending
    <br />
